cordova.define("com.cmpsoft.mobile.plugin.localnotification.FGLocalNotification", function(require, exports, module) { /*-
 ...
 */
        ...
        LocalNotification.prototype.add = function(options) {
                ...
                cordova.exec(null, null, 'FGLocalNotification', 'add', new Array(defaults));
        };
        ...
        LocalNotification.prototype.cancel = function(notificationId) {
                cordova.exec(null, null, 'FGLocalNotification', 'cancel', new Array({
                        id : notificationId
                }));
        };
        ...
        LocalNotification.prototype.cancelAll = function() {
                cordova.exec(null, null, 'FGLocalNotification', 'cancelAll', new Array());
        };
        /**
