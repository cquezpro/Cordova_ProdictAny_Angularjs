'use strict';
var bsSwitchDirective = angular.module('bsSwitchDirective', []);


  bsSwitchDirective.directive('bsSwitch', function ($timeout) {
    return {
      restrict: 'EA',
      require: 'ngModel',
      template: '<input>',
      ...
      link: function link(scope, element, attrs, controller) {
        ...
        element.on('switchChange.bootstrapSwitch', function (event, val, e) {                                      
            attrs.dataOn = val;            
            scope.ngModel = val;            
            scope.$apply();
         });
